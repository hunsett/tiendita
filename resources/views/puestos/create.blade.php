    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-sm text-slate-300 max-w-xl">
                Crea un nuevo puesto para definir mejor las funciones dentro de
                <span class="font-semibold">Tienda Mary</span>.
            </p>
        </div>
        ...
        <div class="relative rounded-[2rem] overflow-hidden shadow-2xl">
            ...
            <div class="relative px-6 py-7 text-slate-50">
                <form action="{{ route('puestos.store') }}" method="POST" class="max-w-md">
                    @csrf
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            value="{{ old('nombre') }}"
                            required
                            placeholder="Ej. Cajero, Gerente de tienda"
                        >
