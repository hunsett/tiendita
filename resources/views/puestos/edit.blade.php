    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-sm text-slate-300 max-w-xl">
                Actualiza la información del puesto. Los cambios ayudarán a mantener claras
                las responsabilidades dentro de <span class="font-semibold">Tienda Mary</span>.
            </p>
        </div>
        ...
        <div class="relative rounded-[2rem] overflow-hidden shadow-2xl">
            ...
            <div class="relative px-6 py-7 text-slate-50">
                <form action="{{ route('puestos.update', $puesto) }}" method="POST" class="max-w-md">
                    @csrf
                    @method('PUT')
