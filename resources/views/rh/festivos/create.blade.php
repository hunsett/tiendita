...
@section('title', 'Nuevo día festivo – RH')
            ...
            <div class="relative text-slate-50">
                ...
                <div class="px-6 py-4 border-b border-white/20">
                    ...
                    <p class="mt-1 text-xs text-slate-200/80">
                        Registra una nueva fecha que el sistema excluirá del conteo de días hábiles.
                    </p>
                </div>
                ...
                <div class="px-6 py-5 text-sm space-y-4">
                    ...
                    <form action="{{ route('rh.festivos.store') }}" method="POST" class="space-y-4">
                        @csrf
